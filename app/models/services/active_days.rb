...
module Services
  class ActiveDays
    ...
    def register_day
      @user_regitser_day = @user.active_days.build(start_week: @start_week, end_week: @end_week,
                                                   day: @today_day_number, mensage: ActiveDay.motivacional_message)
      return unless @user_regitser_day.save

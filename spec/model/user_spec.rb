...
RSpec.describe User, type: :model do
  before(:each) do
    @user = User.create!(email: 'juanf@gmail.com', password: 'feliper1972', name: 'Felipe', last_name: 'Ruiz',
                         years: '21')
  end
  ...
  describe 'validations' do
    ...
    it 'debería devolver error por email repetido' do
      otro_usuario = User.new(email: 'juanf@gmail.com', password: 'otracontraseña', name: 'Otro', last_name: 'Usuario',
                              years: '30')

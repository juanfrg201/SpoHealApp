...
RSpec.describe UserRoutesController, type: :controller do
  describe 'GET #index' do
    it 'returns http success when user is authenticated' do
      ...
      Route.create(presure: 'alta', level: 'intenso',
                   description: 'Una ruta en donde el nivel de ejercicios he intensidad es alto , y el nivel de presion es alto')
      get :index
  ...
  describe 'GET #new' do
    it 'returns good response' do
      ...
      route = Route.create(presure: 'alta', level: 'intenso',
                           description: 'Una ruta en donde el nivel de ejercicios he intensidad es alto , y el nivel de presion es alto')
